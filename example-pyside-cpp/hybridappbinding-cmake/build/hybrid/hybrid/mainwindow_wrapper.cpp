...
MainWindowWrapper::MainWindowWrapper(QWidget * parent) : MainWindow(parent) {
    // ... middle
}
...
void MainWindowWrapper::childEvent(QChildEvent * arg__1)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return ;
...
void MainWindowWrapper::connectNotify(const char * signal)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return ;
...
QMenu * MainWindowWrapper::createPopupMenu()
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.createPopupMenu", Shiboken::SbkType< QMenu >()->tp_name, pyResult->ob_type->tp_name);
        return ((::QMenu*)0);
    }
    ::QMenu* cppResult;
...
void MainWindowWrapper::customEvent(QEvent * arg__1)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return ;
...
int MainWindowWrapper::devType() const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.devType", "int", pyResult->ob_type->tp_name);
        return ((int)0);
    }
    int cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void MainWindowWrapper::disconnectNotify(const char * signal)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return ;
...
void MainWindowWrapper::enterEvent(QEvent * event)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return ;
...
bool MainWindowWrapper::event(QEvent * event)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.event", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
bool MainWindowWrapper::eventFilter(QObject * arg__1, QEvent * arg__2)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return ((bool)0);
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.eventFilter", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
bool MainWindowWrapper::focusNextPrevChild(bool next)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.focusNextPrevChild", "bool", pyResult->ob_type->tp_name);
        return ((bool)0);
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
int MainWindowWrapper::heightForWidth(int arg__1) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<int>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.heightForWidth", "int", pyResult->ob_type->tp_name);
        return ((int)0);
    }
    int cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QVariant MainWindowWrapper::inputMethodQuery(Qt::InputMethodQuery arg__1) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.inputMethodQuery", "QVariant", pyResult->ob_type->tp_name);
        return ::QVariant();
    }
...
void MainWindowWrapper::languageChange()
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return ;
...
int MainWindowWrapper::metric(QPaintDevice::PaintDeviceMetric arg__1) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<int>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.metric", "int", pyResult->ob_type->tp_name);
        return ((int)0);
    }
    int cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QSize MainWindowWrapper::minimumSizeHint() const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.minimumSizeHint", Shiboken::SbkType< QSize >()->tp_name, pyResult->ob_type->tp_name);
        return ::QSize();
    }
...
QPaintEngine * MainWindowWrapper::paintEngine() const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.paintEngine", Shiboken::SbkType< QPaintEngine >()->tp_name, pyResult->ob_type->tp_name);
        return ((::QPaintEngine*)0);
    }
...
QSize MainWindowWrapper::sizeHint() const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppValueConvertible((SbkObjectType*)SbkPySide_QtCoreTypes[SBK_QSIZE_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "MainWindow.sizeHint", Shiboken::SbkType< QSize >()->tp_name, pyResult->ob_type->tp_name);
        return ::QSize();
    }
    ::QSize cppResult = ::QSize();
    pythonToCpp(pyResult, &cppResult);
...
void MainWindowWrapper::timerEvent(QTimerEvent * arg__1)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return ;
...
Sbk_MainWindow_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (!PyArg_ParseTuple(args, "|O:MainWindow", &(pyArgs[0])))
        return -1;


    // Overloaded function decisor
    // 0: MainWindow(QWidget*)
    if (numArgs == 0) {
        overloadId = 0; // MainWindow(QWidget*)
    ...
    if (overloadId == -1) goto Sbk_MainWindow_Init_TypeError;
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "hybrid.MainWindow(): got multiple values for keyword argument 'parent'.");
                return -1;
            } else if (value) {
                pyArgs[0] = value;
        ...
        if (!PyErr_Occurred()) {
            ...
            if (addr) {
                cptr = new (addr) ::MainWindowWrapper(cppArg0);
                PySide::setNextQObjectMemoryAddr(0);
            } else {
                cptr = new ::MainWindowWrapper(cppArg0);
            }
    ...
    if (!cptr) goto Sbk_MainWindow_Init_TypeError;
    ...
    Sbk_MainWindow_Init_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "hybrid.MainWindow", overloads);
        return -1;
}
...
static PyObject* Sbk_MainWindow_get_viewer(PyObject* self, void*)
{
    ::MainWindow* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::MainWindow*)Shiboken::Conversions::cppPointer(SbkhybridTypes[SBK_MAINWINDOW_IDX], (SbkObject*)self));
    PyObject* pyOut = Shiboken::Conversions::pointerToPython((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QGRAPHICSVIEW_IDX], cppSelf->viewer);
    return pyOut;
}
static int Sbk_MainWindow_set_viewer(PyObject* self, PyObject* pyIn, void*)
{
    ::MainWindow* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    cppSelf = ((::MainWindow*)Shiboken::Conversions::cppPointer(SbkhybridTypes[SBK_MAINWINDOW_IDX], (SbkObject*)self));
    if (pyIn == 0) {
        PyErr_SetString(PyExc_TypeError, "'viewer' may not be deleted");
        return -1;
    }
    PythonToCppFunc pythonToCpp;
    if (!(pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QGRAPHICSVIEW_IDX], (pyIn)))) {
        PyErr_SetString(PyExc_TypeError, "wrong type attributed to 'viewer', 'QGraphicsView' or convertible type expected");
        return -1;
    }

    ::QGraphicsView*& cppOut_ptr = cppSelf->viewer;
    pythonToCpp(pyIn, &cppOut_ptr);

    Shiboken::Object::keepReference(reinterpret_cast<SbkObject*>(self), "viewer", pyIn);
    return 0;
}

static PyObject* Sbk_MainWindow_get_scene(PyObject* self, void*)
{
    ::MainWindow* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::MainWindow*)Shiboken::Conversions::cppPointer(SbkhybridTypes[SBK_MAINWINDOW_IDX], (SbkObject*)self));
    PyObject* pyOut = Shiboken::Conversions::pointerToPython((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QGRAPHICSSCENE_IDX], cppSelf->scene);
    return pyOut;
}
static int Sbk_MainWindow_set_scene(PyObject* self, PyObject* pyIn, void*)
{
    ::MainWindow* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    cppSelf = ((::MainWindow*)Shiboken::Conversions::cppPointer(SbkhybridTypes[SBK_MAINWINDOW_IDX], (SbkObject*)self));
    if (pyIn == 0) {
        PyErr_SetString(PyExc_TypeError, "'scene' may not be deleted");
        return -1;
    }
    PythonToCppFunc pythonToCpp;
    if (!(pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QGRAPHICSSCENE_IDX], (pyIn)))) {
        PyErr_SetString(PyExc_TypeError, "wrong type attributed to 'scene', 'QGraphicsScene' or convertible type expected");
        return -1;
    }

    ::QGraphicsScene*& cppOut_ptr = cppSelf->scene;
    pythonToCpp(pyIn, &cppOut_ptr);

    Shiboken::Object::keepReference(reinterpret_cast<SbkObject*>(self), "scene", pyIn);
    return 0;
}

static PyObject* Sbk_MainWindow_get_pb_commit(PyObject* self, void*)
{
    ::MainWindow* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::MainWindow*)Shiboken::Conversions::cppPointer(SbkhybridTypes[SBK_MAINWINDOW_IDX], (SbkObject*)self));
    PyObject* pyOut = Shiboken::Conversions::pointerToPython((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPUSHBUTTON_IDX], cppSelf->pb_commit);
    return pyOut;
}
static int Sbk_MainWindow_set_pb_commit(PyObject* self, PyObject* pyIn, void*)
{
    ::MainWindow* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    cppSelf = ((::MainWindow*)Shiboken::Conversions::cppPointer(SbkhybridTypes[SBK_MAINWINDOW_IDX], (SbkObject*)self));
    if (pyIn == 0) {
        PyErr_SetString(PyExc_TypeError, "'pb_commit' may not be deleted");
        return -1;
    }
    PythonToCppFunc pythonToCpp;
    if (!(pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPUSHBUTTON_IDX], (pyIn)))) {
        PyErr_SetString(PyExc_TypeError, "wrong type attributed to 'pb_commit', 'QPushButton' or convertible type expected");
        return -1;
    }

    ::QPushButton*& cppOut_ptr = cppSelf->pb_commit;
    pythonToCpp(pyIn, &cppOut_ptr);

    Shiboken::Object::keepReference(reinterpret_cast<SbkObject*>(self), "pb_commit", pyIn);
    return 0;
}

static PyObject* Sbk_MainWindow_get_editor(PyObject* self, void*)
{
    ::MainWindow* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = ((::MainWindow*)Shiboken::Conversions::cppPointer(SbkhybridTypes[SBK_MAINWINDOW_IDX], (SbkObject*)self));
    PyObject* pyOut = Shiboken::Conversions::pointerToPython((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPLAINTEXTEDIT_IDX], cppSelf->editor);
    return pyOut;
}
static int Sbk_MainWindow_set_editor(PyObject* self, PyObject* pyIn, void*)
{
    ::MainWindow* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    cppSelf = ((::MainWindow*)Shiboken::Conversions::cppPointer(SbkhybridTypes[SBK_MAINWINDOW_IDX], (SbkObject*)self));
    if (pyIn == 0) {
        PyErr_SetString(PyExc_TypeError, "'editor' may not be deleted");
        return -1;
    }
    PythonToCppFunc pythonToCpp;
    if (!(pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible((SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QPLAINTEXTEDIT_IDX], (pyIn)))) {
        PyErr_SetString(PyExc_TypeError, "wrong type attributed to 'editor', 'QPlainTextEdit' or convertible type expected");
        return -1;
    }

    ::QPlainTextEdit*& cppOut_ptr = cppSelf->editor;
    pythonToCpp(pyIn, &cppOut_ptr);

    Shiboken::Object::keepReference(reinterpret_cast<SbkObject*>(self), "editor", pyIn);
    return 0;
}

// Getters and Setters for MainWindow
static PyGetSetDef Sbk_MainWindow_getsetlist[] = {
    {const_cast<char*>("viewer"), Sbk_MainWindow_get_viewer, Sbk_MainWindow_set_viewer},
    {const_cast<char*>("scene"), Sbk_MainWindow_get_scene, Sbk_MainWindow_set_scene},
    {const_cast<char*>("pb_commit"), Sbk_MainWindow_get_pb_commit, Sbk_MainWindow_set_pb_commit},
    {const_cast<char*>("editor"), Sbk_MainWindow_get_editor, Sbk_MainWindow_set_editor},
    {0}  // Sentinel
};
...
static void* Sbk_MainWindowSpecialCastFunction(void* obj, SbkObjectType* desiredType)
{
    MainWindow* me = reinterpret_cast< ::MainWindow*>(obj);
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType Sbk_MainWindow_Type = { { {
    PyVarObject_HEAD_INIT(&SbkObjectType_Type, 0)
    /*tp_name*/             "hybrid.MainWindow",
    ...
    /*tp_doc*/              0,
    /*tp_traverse*/         Sbk_MainWindow_traverse,
    /*tp_clear*/            Sbk_MainWindow_clear,
    /*tp_richcompare*/      0,
    /*tp_weaklistoffset*/   0,
    /*tp_iter*/             0,
    /*tp_iternext*/         0,
    /*tp_methods*/          Sbk_MainWindow_methods,
    /*tp_members*/          0,
    /*tp_getset*/           Sbk_MainWindow_getsetlist,
    /*tp_base*/             0,
    /*tp_dict*/             0,
    /*tp_descr_get*/        0,
    /*tp_descr_set*/        0,
    /*tp_dictoffset*/       0,
    /*tp_init*/             Sbk_MainWindow_Init,
    /*tp_alloc*/            0,
...
static void* Sbk_MainWindow_typeDiscovery(void* cptr, SbkObjectType* instanceType)
{
...
static void MainWindow_PythonToCpp_MainWindow_PTR(PyObject* pyIn, void* cppOut) {
    Shiboken::Conversions::pythonToCppPointer(&Sbk_MainWindow_Type, pyIn, cppOut);
}
static PythonToCppFunc is_MainWindow_PythonToCpp_MainWindow_PTR_Convertible(PyObject* pyIn) {
    if (pyIn == Py_None)
        return Shiboken::Conversions::nonePythonToCppNullPtr;
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)&Sbk_MainWindow_Type))
...
static PyObject* MainWindow_PTR_CppToPython_MainWindow(const void* cppIn) {
    return PySide::getWrapperForQObject((::MainWindow*)cppIn, &Sbk_MainWindow_Type);

}

void init_MainWindow(PyObject* module)
{
    SbkhybridTypes[SBK_MAINWINDOW_IDX] = reinterpret_cast<PyTypeObject*>(&Sbk_MainWindow_Type);

    if (!Shiboken::ObjectType::introduceWrapperType(module, "MainWindow", "MainWindow*",
        &Sbk_MainWindow_Type, &Shiboken::callCppDestructor< ::MainWindow >, (SbkObjectType*)SbkPySide_QtGuiTypes[SBK_QMAINWINDOW_IDX])) {
        return;
    }

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(&Sbk_MainWindow_Type,
    ...
    Shiboken::ObjectType::setMultipleIheritanceFunction(&Sbk_MainWindow_Type, func);
    Shiboken::ObjectType::setCastFunction(&Sbk_MainWindow_Type, &Sbk_MainWindowSpecialCastFunction);
    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(&Sbk_MainWindow_Type, &Sbk_MainWindow_typeDiscovery);

    PySide::Signal::registerSignals(&Sbk_MainWindow_Type, &::MainWindow::staticMetaObject);

    Shiboken::ObjectType::setSubTypeInitHook(&Sbk_MainWindow_Type, &PySide::initQObjectSubType);
    PySide::initDynamicMetaObject(&Sbk_MainWindow_Type, &::MainWindow::staticMetaObject, sizeof(::MainWindow));
}
